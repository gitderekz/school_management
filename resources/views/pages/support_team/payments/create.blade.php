            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">Amount ({{--<del style="text-decoration-style: double">Tsh</del>--}}Tsh) <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
